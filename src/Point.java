...
public class Point {
    ...
    //getY instance method without any parameters
    ...
    /*distance method without parameter with double return type to calculate
    ...
    /* distance method with parameter with double return type to calculate
    distance between two points
     */
    ...
    Point second = new Point(3,1);
        ...
        System.out.println("distance(2,2)= " + first.distance(2,2));
        Point point = new Point();
        System.out.println("distnace()=" + point.distance());
